...
import 'package:untitled9/screen/imagepicker.dart';
import 'package:untitled9/screen/widget/custom_caches_network_image.dart';
import 'package:untitled9/screen/widget/custom_care.dart';
import 'package:untitled9/screen/widget/custom_characteristics.dart';
import 'package:untitled9/screen/widget/custom_condition.dart';
import 'package:untitled9/screen/widget/custom_gallery.dart';
import 'package:untitled9/screen/widget/custom_known.dart';
import 'package:untitled9/screen/widget/custom_page_view_title_gallery.dart';
import 'package:untitled9/screen/widget/custom_title_info.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: InkWell(
              onTap: () {Get.to(imagepicer_screen());             },
              child: Icon(
                Icons.chevron_left,
                color: Colors.black,
              )),
